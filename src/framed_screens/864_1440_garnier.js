...
import '../styles/864_1440.css';
import '../styles/serial.css';

const style = { backgroundImage: 'url(/backgrounds/bottom_864_1440.png)' };
const styleTop = { backgroundImage: 'url(/backgrounds/top_864_1440.png)' };

class _864_1440_Garnier extends Component {
    constructor(props) {
        super(props);
        this.state = {
            image: "",
    ...
    render() {
        return (
            <div id="bg" className="bg" style={style}>
                <img id="image" className="image_864_1440" height="1" width="1440"></img>
                <img id="image2" className="image_864_1440" height="1" width="1440"></img>
...
export default _864_1440_Garnier;