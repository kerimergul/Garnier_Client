...
import '../styles/768_1344.css';
import '../styles/serial.css';

const style = { backgroundImage: 'url(/backgrounds/bottom_768_1344.png)' };
const styleTop = { backgroundImage: 'url(/backgrounds/top_768_1344.png)' };

class _768_1344_Garnier extends Component {
    constructor(props) {
        super(props);
        this.state = {
            image: "",
    ...
    render() {
        return (
            <div id="bg" className="bg" style={style}>
                <img id="image" className="image_768_1344" height="1" width="1344"></img>
                <img id="image2" className="image_768_1344" height="1" width="1344"></img>
...
export default _768_1344_Garnier;