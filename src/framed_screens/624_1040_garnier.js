...
import '../styles/624_1040.css';
import '../styles/serial.css';

const style = { backgroundImage: 'url(/backgrounds/bottom_624_1040.png)' };
const styleTop = { backgroundImage: 'url(/backgrounds/top_624_1040.png)' };

class _624_1040_Garnier extends Component {
    constructor(props) {
        super(props);
        this.state = {
            image: "",
    ...
    render() {
        return (
            <div id="bg" className="bg" style={style}>
                <img id="image" className="image_624_1040" height="1" width="1040"></img>
                <img id="image2" className="image_624_1040" height="1" width="1040"></img>
...
export default _624_1040_Garnier;