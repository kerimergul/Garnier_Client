...
import '../styles/1152_1920.css';

const style = { backgroundImage: 'url(/backgrounds/1152_1920.png)' };

class _1152_1920_Gomulu extends Component {
    constructor(props) {
        super(props);
        this.state = {
            currentVideoIndex: 0,
    ...
    render() {
        return (
            <div id="bg" className="bg" style={style}>
                ...
                <div id="serial" class="serial_1152_1920">MAT-TR-2400608</div>
            </div>
        );
    }
}

export default _1152_1920_Gomulu;